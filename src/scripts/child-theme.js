...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.querySelectorAll('.card-checkmark label').forEach(function (label) {
		label.addEventListener('click', function () {
			...
			userSelections.forEach(function (pick) {
				...
				emailListItems += '<li style="padding-bottom: 20px"><strong>' + printYear + '</strong> - <a style="font-weight:700;" href="' + pick.link + '">' + pick.title +
	...
	var emailBodyBottom =
		'</div><!--&#91;if mso | IE&#93;></td></tr></table><!&#91;endif&#93;--></td></tr></tbody></table></div><!--&#91;if mso | IE&#93;></td></tr></table></td></tr></table><!&#91;endif&#93;--></td></tr></tbody></table></div><!--&#91;if mso | IE&#93;></td></tr></table><!&#91;endif&#93;--><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td><!--&#91;if mso | IE&#93;><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><!&#91;endif&#93;--><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;"><!--&#91;if mso | IE&#93;><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><!&#91;endif&#93;--><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0"role="presentation" style="width:100%;"><tbody><tr><tdstyle="direction:ltr;font-size:0px;padding:20px 0;text-align:center;"><!--&#91;if mso | IE&#93;><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><!&#91;endif&#93;--><div class="mj-column-per-100 mj-outlook-group-fix"style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0"role="presentation" width="100%"><tbody><tr><tdstyle="vertical-align:top;padding:0;"><table border="0" cellpadding="0"cellspacing="0"role="presentation"width="100%"><tr><td align="center"style="font-size:0px;padding:0;word-break:break-word;"><!--&#91;if mso | IE&#93;><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://www.facebook.com/ASUEngineering"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/square-facebook-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://twitter.com/ASUEngineering"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/square-x-twitter-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://instagram.com/asuengineering"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/square-instagram-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://www.linkedin.com/school/ira-a.-fulton-schools-of-engineering-at-arizona-state-university/"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/linkedin-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://www.flickr.com/photos/fultonengineering"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/flickr-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td><td><!&#91;endif&#93;--><table align="center"border="0"cellpadding="0"cellspacing="0"role="presentation"style="float:none;display:inline-table;"><tr><tdstyle="padding:4px;"><tableborder="0"cellpadding="0"cellspacing="0"role="presentation"style="background:#A1A0A0;border-radius:3px;width:30px;"><tr><tdstyle="font-size:0;height:30px;vertical-align:middle;width:30px;"><a href="https://www.youtube.com/channel/UCdVEpfvW2EGZYXIxiiQX9fA"target="_blank"><imgheight="30"src="https://students.engineering.asu.edu/customize/wp-content/themes/pitchfork-customize/src/img/square-youtube-brands-solid.png"style="border-radius:3px;display:block;"width="30"></a></td></tr></table></td></tr></table><!--&#91;if mso | IE&#93;></td></tr></table><!&#91;endif&#93;--></td></tr><tr><td align="center"style="font-size:0px;padding:10px 25px;word-break:break-word;"><divstyle="font-family:Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">You are receivingthis email becauseyou are awesome andhave customized anexperience ofextra-curricularactivities for ASUEngineering.</div></td></tr><tr><td align="center"style="font-size:0px;padding:10px 25px;word-break:break-word;"><divstyle="font-family:Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">ASU Ira A. FultonSchools ofEngineering<br>699 SMill Ave, Tempe, AZ,85281,USA<br>Copyright ©2020 Arizona Boardof Regents</div></td></tr></table></td></tr></tbody></table></div><!--&#91;if mso | IE&#93;></td></tr></table><!&#91;endif&#93;--></td></tr></tbody></table></div><!--&#91;if mso | IE&#93;></td></tr></table></td></tr></table><!&#91;endif&#93;--></td></tr></tbody></table></div><!--&#91;if mso | IE&#93;></td></tr></table><!&#91;endif&#93;--></td></tr></tbody></table></div></body></html>';
